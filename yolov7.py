...
path_model_file_yolov7 = "C:\UIT\streamlit-yolov7\best.pt"
path_model_file_faster = "C:\UIT\streamlit-yolov7\saved_model.pb"
...
# if ok == True:
    ...
    if options == 'Image':
        ...
        if upload_img_file is not None:
            ...
            if pred:
                if gpu_option == 'CPU':
                    model_yolov7 = custom(path_or_model=path_model_file)
                if gpu_option == 'GPU':
